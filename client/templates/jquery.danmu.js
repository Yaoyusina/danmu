        ...
        this.$timer.timer({
            ...
            callback: function (index) {
                setTimeout(function () {
                    ...
                    if(!($(element).data("nowTime"))){
                        $(element).data("nowTime", 0);
                        $(element).data("danmuList", {});
                       // console.log(this.prototype("danmuStop"));
                    ...
                    if ($(element).data("danmuList")[$(element).data("nowTime")] && me.launched.indexOf($(element).data("nowTime")) < 0) {
                        ...
                        for (var i = (danmus.length - 1); i >= 0; i--) {
                            ...
                            if (danmaku.hasOwnProperty('isnew')) {
                                $("#" + me.id + "tempDanmaku").css({"border": "0px solid " + danmaku.color});
                            }
        ...
        if (arg instanceof Array) {
            for (var i in arg) {
                if (this.$element.data("danmuList")[arg[i]["time"]]) {
                    this.$element.data("danmuList")[arg[i]["time"]] = [];  //added at 05262016
            ...
            if (this.$element.data("danmuList")[arg.time]) {
                this.$element.data("danmuList")[arg.time] = []; //added at 05262016
